...
export const ProtectionPersonnel: React.FC = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className="relative py-28 sm:py-36 border-t border-border-subtle bg-background overflow-hidden opacity-0"
    >
      ...
      <Container size="lg">
        ...
        <div className="max-w-3xl mx-auto text-center mb-20 space-y-4">
          ...
          <p className="text-base sm:text-lg font-light text-text-secondary leading-relaxed">
            Sentinel is establishing uncompromising benchmark criteria for every security professional who joins
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center justify-center w-11 h-11 rounded-xl bg-black/[0.03] dark:bg-white/[0.03] border border-border-subtle group-hover:border-accent/40 group-hover:bg-accent/10 transition-all duration-300">
                  ...
                  <h3 className="text-base font-normal text-text-primary mb-1 group-hover:text-accent transition-colors">
                    {std.title}
                  </h3>
                ...
                <div className="pt-4 mt-6 border-t border-border-subtle flex items-center justify-between text-[11px] text-text-muted font-light">
                  <span>Network Requirement</span>
                  <span className="text-emerald-500 font-normal">Mandatory</span>
                </div>
              </Card>
            );
          })}
        ...
        <div className="mt-14 p-6 sm:p-8 rounded-2xl bg-black/[0.02] dark:bg-white/[0.02] border border-border-subtle flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs font-light text-text-secondary mt-0.5">
                ...
                security professionals tailored to their cultural and personal comfort.
              </p>
            </div>
          </div>
          <div className="shrink-0 text-xs font-light text-text-muted border border-border-subtle px-3.5 py-1.5 rounded-full bg-black/[0.02] dark:bg-white/[0.02]">
